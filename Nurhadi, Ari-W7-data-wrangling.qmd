...
::: callout-note
**Note**: This codebook will follow the structure and content of the published codebook for this project: [Data Wrangling with Tidyverse](https://jmjung.quarto.pub/m05-1-principles-data-wrangling-with-tidyverse-in-r/)
:::
...
-   to add a code chunk, use the keyboard shortcut `Ctrl + Alt + I`
...
flights |> 
    ...
    labs(x = "Month",
         y = "Number of Flights",
         title = "Number of Flights by Month During Year 2013 at New York"
        )
```
